            ...
            <b-col xl='12'>
              <div>
                <b-row xl='12' class='mt-2'>
                  <b-col xl=12 class='mt-2 text-center' style='font-size:0.9em'>
                    <h7>
                ...
                <b-row xl='12'>
                  <b-col xl='2' style='font-size:0.8em'>
                    0%
                  </b-col>
                  <b-col xl='8' class='mt-2'>
                    <Slider
                        :format="sliderFormat"
                        showTooltip="drag"
                  ...
                  <b-col xl='2' class='pl-0' style='font-size:0.8em'>
                    100%
                  </b-col>
                </b-row>
              </div>

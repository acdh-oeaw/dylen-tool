          ...
          <b-tabs content-class='mt-3' card>
            ...
            <b-tab title='Time Series Analysis'>
              <b-card-text align='left'>
                ...
                Each graph indicates the diachronic development of a given target word according to the frequency change
                ...
                The first perspective is to compare each subsequent year to the previous one, second - each subsequent year to the first year,
                ...
                periods. Some of the measures make use only of network nodes lists (not the network itself), however the
